...
public class MainLinksLoaderApp implements CommandLineRunner {

    public static void main(String[] args) {
        new SpringApplicationBuilder(MainLinksLoaderApp.class).web(WebApplicationType.NONE).run(args);
    }
    ...
    @Autowired
    private LinksLoaderConfig config;
    ...
    private void doRun(String filePath, String host) throws Exception {
        ...
        Job job = config.linksLoaderJob(filePath, host);
